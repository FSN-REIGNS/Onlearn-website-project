...
import { $ as $fetch, h as hasProtocol, i as isScriptProtocol, k as joinURL, w as withQuery, s as sanitizeStatusCode, l as getContext, m as createHooks, c as createError$1, t as toRouteMatcher, n as createRouter$1 } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CU3t2FQV.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-Dibl7TfK.mjs'))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DNVBE6dj.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DqKh6S4u.mjs'));
